...
def plot_confusion(cm: np.ndarray, classes: List[str], out_path: Path, note: str):
...
def main():
    ...
    train_ds, val_ds, test_ds, _, _, targets, train_idx = build_eval_datasets(
        data_dir, input_size, seed, val_split, test_split
    )
    ...
    plot_confusion(
        ...
        classes,
        cm_path,
        "Confusion matrix on the test set using the tuned rare-class threshold.",
    )
